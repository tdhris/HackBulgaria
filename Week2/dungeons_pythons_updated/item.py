...
WEAPONS = [("Callandor the Sword", 40, 0.3), ("Aiglos the Spear", 35, 0.5),
           ('Axe of the Dwarvish Lords', 30, 0.4), ('Spear of Vix', 60, 0.2),
           ('Mace of Cuthbert', 50, 0.3), ('Hammer of Kharas', 55, 0.5),
           ('Dagger of Time', 70, 0.3)]
